      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="border-2 border-l border-black h-6"></div>
            <div className="ml-4 flex items-center md:ml-6">
             {
              !session?<Link href={'/login'} className="border-1 p-1 px-2 text-white font-medium bg-indigo-500 hover:bg-indigo-600 rounded-md">Login</Link>: <AvatarDropDownMenu />
              }
            </div>
          </div>
        </div>
